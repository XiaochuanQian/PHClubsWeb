	...
	<view class="container">
		<view class="header">
			<view class="logo-container">
				...
				<text class="logo-text">PH Clubs</text>
			</view>
			<view class="nav">
				<text :class="['nav-item', currentPage === 'Home' ? 'active' : '']"
					@click="switchPage('Home')">Home</text>
				<text :class="['nav-item', currentPage === 'Documentation' ? 'active' : '']"
					@click="switchPage('Documentation')">Documentation</text>
				<text :class="['nav-item', currentPage === 'About' ? 'active' : '']"
					@click="switchPage('About')">About</text>
